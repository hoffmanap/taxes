...
| `tx_residential_commercial_split.csv` | Property value by category (single-family, multifamily, commercial, industrial, and other) for El Paso, Austin, Dallas, Fort Worth, Houston, and San Antonio, pulled from the Texas Comptroller's Appraisal District Ratio Study. |
...
10. **Real property tax records confirm the housing-type story from a different angle.** Pulled directly from the Texas Comptroller for El Paso and five Texas peer cities: El Paso's commercial and industrial share of taxable value (27.6%) is not unusually low, it's actually higher than Austin's. What is unusually low is El Paso's multifamily share of taxable value (5.0%), less than half that of any other city in the comparison. Among these six cities, multifamily share correlates strongly with the effective tax rate (r = -0.85, p = 0.03); commercial share does not (r = -0.31, not significant). The data point to multifamily housing, not commercial development, as the lever connected to a lower tax rate (§08).
